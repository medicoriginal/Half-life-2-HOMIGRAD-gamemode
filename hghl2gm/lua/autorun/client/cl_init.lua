...
hook.Add( "HUDPaint", "start", function()	
	...
	draw.DrawText( "НАЧИНАЕМ РЕЖИМ HALF LIFE 2 COOP", "fonta", ScrW() * 0.5, ScrH() * 0.25, color_white, TEXT_ALIGN_CENTER )
	draw.DrawText( "Лидер отряда повстанцев: " .. Entity( 1 ):GetName(), "fontb", ScrW() * 0.5, ScrH() * 0.35, color_white, TEXT_ALIGN_CENTER )
	draw.DrawText( "Название отряда повстанцев: " .. GetHostName(), "fontb", ScrW() * 0.5, ScrH() * 0.45, color_white, TEXT_ALIGN_CENTER )



	hook.Add("HUDPaint", "STATS" , function () 
	draw.SimpleText( "Режим: COOP HL2", "CloseCaption_Bold", 3, 0, color_white, 0, TEXT_ALIGN_TOP )
	
--я из прошлого:сделай тут название карты уровня тип 21:56 23.12.24
--будущий я:ок понял 21:57 23.12.24


draw.SimpleText( "Уровень: " .. game.GetMap(), "CloseCaption_Bold", 3, ScrH() / 45, color_white)
